...
7. Then move to secure booking:
   - `P02-T01`, `P02-T02`, `P02-T03`, `P02-T04`
...
- `tests/p01-T02.order-schema.test.ts`
- `tests/p01-t01.service-catalog.spec.ts`
...
- Latest push: `chore/P00-T02-import-wed3s-baseline` -> `origin/main`
- Latest commit: `38ee1b9`
